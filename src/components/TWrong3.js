...
const TWrong3 = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(trig1);
        console.log(trig2);
        if (upCo1=="1" && trig1 == "none" && upCo2=="1.57" && upCo3=="0.5" && trig2=="sin" && upCo4=="3.14" && upCo5=="0" && trig3=="none" && upCo6=="1" && upCo7=="1" && trig4=="sin" && upCo8=="0") {
      ...
      <>
        ...
        <section>
          ...
          <h5 className="my-5 mx-5">
            In this case f(x) = 2cos <sup>2</sup>x + sec <sup>2</sup>x and b (upperlimit) = {Math.PI/2} and a
            (lowerlimit)=0
          </h5>
          <h5 className="my-5">
            <span className='mx-5'> Substitute Here: (Enter the angle in rad) </span>
            <br />
             (<input
          className="mx-2"
