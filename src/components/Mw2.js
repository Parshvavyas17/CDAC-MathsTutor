          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <br />2 . Now apply Integration by parts in the first term where
                take u = (x+1)<sup>-1</sup> and v = e <sup></sup>
              </div>
              <div class="modal-footer">
                <button
                  type="button"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <br />
                <br />
                After Solving from the above hint , the term inside the integral
                should get cancelled with the second term obatined after
