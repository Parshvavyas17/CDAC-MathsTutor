...
const Lw3 = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="header">
          <b className="text">Logarithmic Equation:</b>
        </h2>
      </header>
      <section>
        ...
        <h5 className="my-5">
          <span className="mx-5"> Substitute Here: </span>
          <br />
          (
          <input
            className="mx-2"
              ...
              <div class="modal-body">
                <ol>
                  <li>
                    ...
                    F(b)- F(a) <br></br> Here F(b) is the integrated equation
                    after substituting the upper limit
