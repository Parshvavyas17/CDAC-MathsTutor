...
export default function TWrong1() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      alert("Right Answer");
      navigate("/tw3", { state: equation });
    } else {
      alert("Wrong Answer");
      setUpCo1("");
      setUpCo2("");

      navigate("/tw2", { state: equation });
    }
  };
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <b>
                {" "}
                Since cos<sup>2</sup>x cannot be directly integrated we need to
                Use the formula for Expansion of cos x .
              </b>
            </div>
